...
import * as helpers from '@/helpers/funciones.js';
...
axios.interceptors.request.use((config) => {
    ...
    if (config.url != 'autenticar' && config.url != 'refresh') {
        if (!helpers.isTokenActive()) {
            router.push('/login')
            return Promise.reject('Solicitud detenida por un motivo de token')
        }
    ...
    // console.error('Error en el middleware de solicitud:', error);
